...
const EmployeeManagement = () => {
    ...
    // Get store_id from location state or props
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="h-full mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 min-w-0 flex-1">
                        ...
                        <h1 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-gray-800 truncate">Employee Management</h1>
                        <p className='text-xs text-gray-400'>Manage store employees and access permissions.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-1 sm:gap-2 lg:gap-3 flex-shrink-0'>
                        ...
                        <button
                        onClick={() => navigate('/internal/admin/employee/create', {state: {store_id: store_id}})}
                        ...
                        <div key={employee.id} className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border border-gray-200 shadow-sm transition-all hover:shadow-md hover:border-blue-200">
                            ...
                            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                                ...
                                <button 
                                    ...
                                    onClick={() => navigate('/internal/admin/employee/create', {state: {employeeState: employee, store_id: store_id}})}
                                >
                                    <Edit3 size={16} />
                                    Edit
                                </button>
